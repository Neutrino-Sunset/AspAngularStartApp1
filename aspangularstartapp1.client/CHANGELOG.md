...
- Create Angular project with ng: `ng new aspangularstartapp1.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`aspangularstartapp1.client.esproj`).
